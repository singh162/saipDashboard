export default {
	...
	async showFilterArray (type) {
		...
		} else if (type === 'Full Name' || type === 'Company Name' || type === 'Right Holder Name' || type === 'Email Address' || type === 'Authorized Representative Phone Number' || type === 'City' || type === 'State' || type === 'Country' || type === 'Infringing Url' || type === 'Orginal Work / Website' || type === 'Status' || type === 'Status Updated By' ||  type === 'Authorized Representative' || type === 'Right Holder Email' || type === 'Title Name' ) {
			this.filterArray = [
				{ name: "Equals", code: "EQUAL" },
